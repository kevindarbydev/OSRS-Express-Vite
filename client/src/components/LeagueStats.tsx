...
const LeagueStats = ({ data }: { data?: CombinedData[] }) => {
  ...
  const [leagueData, setLeagueData] = useState<any[]>([]); // TODO: Adjust the type according to the actual type of leagueStats.skills and leagueStats.bosses
  useEffect(() => {
    if (data) {
